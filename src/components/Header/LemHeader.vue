  ...
  <header class="text-gray-600 body-font">
    <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
      <a class="flex title-font font-medium items-center text-gray-900 mb-4 md:mb-0">
        <div class="w-32 lg:w-30">
          <router-link to="/"><img src="../../assets/images/logo.png" alt="logo" class="w-full"></router-link>
        </div>
      </a>
      ...
      <button
        class="flex px-8 py-3 text-2xl font-bold text-brand-main rounded bg-brand-graydark focus:outline-none md:text-base"
        @click="() => $emit('login')"
      >
        Entrar
      </button>
